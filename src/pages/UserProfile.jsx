    ...
    return userData.posts.map((post, index) => (
      <div className="card mb-3" key={index}>
        <div className="card-body">
          ...
          {post.image && <img src={post.image} className="post-image img-fluid rounded mb-2" alt="Post" />}
          {post.audio && (
        ...
        <div className="col-12 col-md-8 col-lg-6">
          <div className="profile-container">
            ...
            <div className="profile-header position-relative">
              ...
              <div className="profile-picture-container" onClick={triggerFileInput} style={{cursor: 'pointer'}}>
