 ...
 * @description Componente funcional React que exibe o conteúdo das Políticas de Privacidade.
 * Ele carrega a data atual, mas exibe uma data de "Última atualização" fixa no conteúdo.
 * @returns {JSX.Element} O componente de Políticas de Privacidade renderizado.
 */
